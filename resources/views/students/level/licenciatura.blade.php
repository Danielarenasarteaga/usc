...
<div class='col-lg-4 col-lg-offset-4'>
    ...
    <h1><i class='fa fa-user-plus'></i>Crear nuevo alumno en licenciatura</h1>
    <hr>

    {{ Form::open(array('url' => 'students')) }}

    <div class="form-group">
        {{ Form::label('request', 'Solicitud de inscripción a la licenciatura') }}
    ...
    <div class="form-group">
        {{ Form::label('bachelors degree', 'Licenciatura') }}
        {{ Form::text('bachelors degree', '', array('class' => 'form-control')) }}
    </div>

    <div class="form-group">
        {{ Form::label('quarter', 'Cuatrimestre a ingresar') }}
        {{ Form::text('quarter', '', array('class' => 'form-control')) }}
    </div>
