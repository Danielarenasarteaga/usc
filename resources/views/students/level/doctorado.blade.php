...
<div class='col-lg-4 col-lg-offset-4'>
    ...
    <h1><i class='fa fa-user-plus'></i>Crear nuevo alumno en doctorado</h1>
    <hr>

    {{ Form::open(array('url' => 'students')) }}

    <div class="form-group">
        {{ Form::label('request', 'Solicitud de inscripción a la doctorado') }}
    ...
    <div class="form-group">
        {{ Form::label('doctorate', 'Doctorado en') }}
        {{ Form::text('doctorate', '', array('class' => 'form-control')) }}
    </div>
